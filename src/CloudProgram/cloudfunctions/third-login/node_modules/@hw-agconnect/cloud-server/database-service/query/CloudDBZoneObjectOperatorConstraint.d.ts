 ...
 */
/**
 * CloudDBZoneObjectOperatorConstraint is the constraint of operated object.
 */
export declare class CloudDBZoneObjectOperatorConstraint<T> {
    private readonly clazz;
    private readonly clazzInstance;
     ...
     *
     * @param clazz The object type class or object type name.
     * @returns The `CloudDBZoneObjectOperatorConstraint` instance of clazz.
     */
    static build<T>(clazz: (new () => T) | string): CloudDBZoneObjectOperatorConstraint<T>;
    /**
     ...
     * @returns CloudDBZoneObjectOperatorConstraint itself.
     */
    byUid(uid: string): CloudDBZoneObjectOperatorConstraint<T>;
    /**
     * Get clazzInstance .
     *
     * @returns clazzInstance.
     */
    getClazzInstance(): any;
    getConditions(): any[];
    getClazz(): new () => T;
    private isGenericObject;
    getSerializeQueryCondition(): any[];
