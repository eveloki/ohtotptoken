...
export declare class Utils {
    private static readonly TRACE_ID_EXP;
    private static readonly DATE_REG_EXP;
    private static readonly NUMBER_REG_EXP;
    private static readonly MAX_OBJECT_CAPACITY;
    private static readonly RANDOM_DIVISOR;
    private static readonly RANDOM_VALUE;
    private static readonly RANDOM_RANGE;
    private static readonly HEX;
    private static readonly TRACE_ID_LENGTH;
    private static readonly RANDOM_KEY_LENGTH;
    private static readonly KEY_DELETE_TIME;
    private static readonly OBJECT_TYPE_EXP;
    private static readonly SYSTEM_OBJECT_TYPES;
    private static readonly FIELD_NAME_EXP;
     ...
     */
    static deserializeObjects(objects: any[], fieldTypeMap: Map<string, string>, targetClass: any, objectTypeName: string): any[];
    ...
    static addCondition(conditionType: string, fieldName: string | null, fieldType: string | null, value?: any): any;
    static serializeGenericObjQuery(queryConditions: any[], begin?: Date, end?: Date): any[];
    private static getInCondition;
    /**
     ...
     */
    static serializeQueryConditions(queryConditions: any[], fieldTypeMap: Map<string, string>, begin?: Date, end?: Date): any[];
    /**
    ...
    private static getSecRandom;
    static checkTraceId(traceId: string): boolean;
    static primaryKeyCompareTo(object1: any, object2: any, filedType: string): any;
    static isNumberString(numberStr: string): boolean;
    static longCompareTo(object1: string, object2: string): number;
    static serializeMapObject(object: any, map: Map<string, any>): any;
    static deepCopy(objectList: any[]): any[];
    static checkObjectTypeName(objectTypeName: string): void;
    static checkFieldName(fieldName: string): void;
    static checkIllegalCharacter(value: string): void;
}
